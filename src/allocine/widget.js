...
// dashboard-widgets.md): a card-list of today's films at the configured
...
//
// AlloCiné's own "now playing" data (nowPlaying.js) never carries a
// trailerUrl, so the trailer link below is simply never added — no
// AlloCiné-specific branching needed.
// -----------------------------------------------------------------------------
...
function buildNowPlayingContent(movies) {
  ...
  return {
    ...
    // allocine.fr on every dashboard render.
    ttl_seconds: 900,
